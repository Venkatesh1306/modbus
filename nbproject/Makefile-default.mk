...
SOURCEFILES_QUOTED_IF_SPACED=src/test.c src/input_func.c src/error.c src/PresetSingle_reg.c src/ReadInput_reg.c src/ForceSingle_coil.c src/ForceMultiple_coils.c src/PresetMultiple_reg.c src/ReadCoil_Status.c src/main.c src/ReadHolding_reg.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/src/test.o ${OBJECTDIR}/src/input_func.o ${OBJECTDIR}/src/error.o ${OBJECTDIR}/src/PresetSingle_reg.o ${OBJECTDIR}/src/ReadInput_reg.o ${OBJECTDIR}/src/ForceSingle_coil.o ${OBJECTDIR}/src/ForceMultiple_coils.o ${OBJECTDIR}/src/PresetMultiple_reg.o ${OBJECTDIR}/src/ReadCoil_Status.o ${OBJECTDIR}/src/main.o ${OBJECTDIR}/src/ReadHolding_reg.o
POSSIBLE_DEPFILES=${OBJECTDIR}/src/test.o.d ${OBJECTDIR}/src/input_func.o.d ${OBJECTDIR}/src/error.o.d ${OBJECTDIR}/src/PresetSingle_reg.o.d ${OBJECTDIR}/src/ReadInput_reg.o.d ${OBJECTDIR}/src/ForceSingle_coil.o.d ${OBJECTDIR}/src/ForceMultiple_coils.o.d ${OBJECTDIR}/src/PresetMultiple_reg.o.d ${OBJECTDIR}/src/ReadCoil_Status.o.d ${OBJECTDIR}/src/main.o.d ${OBJECTDIR}/src/ReadHolding_reg.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/src/test.o ${OBJECTDIR}/src/input_func.o ${OBJECTDIR}/src/error.o ${OBJECTDIR}/src/PresetSingle_reg.o ${OBJECTDIR}/src/ReadInput_reg.o ${OBJECTDIR}/src/ForceSingle_coil.o ${OBJECTDIR}/src/ForceMultiple_coils.o ${OBJECTDIR}/src/PresetMultiple_reg.o ${OBJECTDIR}/src/ReadCoil_Status.o ${OBJECTDIR}/src/main.o ${OBJECTDIR}/src/ReadHolding_reg.o

# Source Files
SOURCEFILES=src/test.c src/input_func.c src/error.c src/PresetSingle_reg.c src/ReadInput_reg.c src/ForceSingle_coil.c src/ForceMultiple_coils.c src/PresetMultiple_reg.c src/ReadCoil_Status.c src/main.c src/ReadHolding_reg.c
...
${OBJECTDIR}/src/ReadCoil_Status.o: src/ReadCoil_Status.c  .generated_files/flags/default/49a676ac016cae60eeb464af90a0eb67529b96d6 .generated_files/flags/default/da39a3ee5e6b4b0d3255bfef95601890afd80709
	@${MKDIR} "${OBJECTDIR}/src" 
...
${OBJECTDIR}/src/ReadHolding_reg.o: src/ReadHolding_reg.c  .generated_files/flags/default/1801a60ec19061aa98d08ed9acc5cd6aee763204 .generated_files/flags/default/da39a3ee5e6b4b0d3255bfef95601890afd80709
	@${MKDIR} "${OBJECTDIR}/src" 
	@${RM} ${OBJECTDIR}/src/ReadHolding_reg.o.d 
	@${RM} ${OBJECTDIR}/src/ReadHolding_reg.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  src/ReadHolding_reg.c  -o ${OBJECTDIR}/src/ReadHolding_reg.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MP -MMD -MF "${OBJECTDIR}/src/ReadHolding_reg.o.d"      -g -D__DEBUG -D__MPLAB_DEBUGGER_SIMULATOR=1    -omf=elf -DXPRJ_default=$(CND_CONF)    $(COMPARISON_BUILD)  -mlarge-code -mlarge-data -mlarge-scalar -O0 -msmart-io=1 -Wall -msfr-warn=off    -mdfp="${DFP_DIR}/xc16"
...
${OBJECTDIR}/src/ReadCoil_Status.o: src/ReadCoil_Status.c  .generated_files/flags/default/ae01780d51db4792a52a1880bcd05a3fe499dc4a .generated_files/flags/default/da39a3ee5e6b4b0d3255bfef95601890afd80709
	@${MKDIR} "${OBJECTDIR}/src" 
	@${RM} ${OBJECTDIR}/src/ReadCoil_Status.o.d 
	@${RM} ${OBJECTDIR}/src/ReadCoil_Status.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  src/ReadCoil_Status.c  -o ${OBJECTDIR}/src/ReadCoil_Status.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MP -MMD -MF "${OBJECTDIR}/src/ReadCoil_Status.o.d"        -g -omf=elf -DXPRJ_default=$(CND_CONF)    $(COMPARISON_BUILD)  -mlarge-code -mlarge-data -mlarge-scalar -O0 -msmart-io=1 -Wall -msfr-warn=off    -mdfp="${DFP_DIR}/xc16"
...
${OBJECTDIR}/src/ReadHolding_reg.o: src/ReadHolding_reg.c  .generated_files/flags/default/3bded7636ca6590024e0211cecc327e32ffc1fa .generated_files/flags/default/da39a3ee5e6b4b0d3255bfef95601890afd80709
	@${MKDIR} "${OBJECTDIR}/src" 
	@${RM} ${OBJECTDIR}/src/ReadHolding_reg.o.d 
	@${RM} ${OBJECTDIR}/src/ReadHolding_reg.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  src/ReadHolding_reg.c  -o ${OBJECTDIR}/src/ReadHolding_reg.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MP -MMD -MF "${OBJECTDIR}/src/ReadHolding_reg.o.d"        -g -omf=elf -DXPRJ_default=$(CND_CONF)    $(COMPARISON_BUILD)  -mlarge-code -mlarge-data -mlarge-scalar -O0 -msmart-io=1 -Wall -msfr-warn=off    -mdfp="${DFP_DIR}/xc16"
